...
/*=============================================================================
  ...
  Parameters:
    ...
    searchExpansion - The original source image is searched at the top locations
                      ...
                      directions
*/
const int fmtNumMaxima = 1;
const int fmtNumDownPyrs = 2;
const int fmtSearchExpansion = 0;
...
FastMatchTemplate(const Mat&      source,
                  ...
                  int             matchPercentage,
                  int             numMaxima = fmtNumMaxima,
                  int             numDownPyrs = fmtNumDownPyrs,
                  int             searchExpansion = fmtSearchExpansion);
